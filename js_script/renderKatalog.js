                ...
                podCategor[j].addEventListener('click', () => {
                    ...
                    for (let tovar in tableCard[i][Object.keys(tableCard[i])[j]]) {
                        ...
                        divObjCatalog.addEventListener('click', () => {
                            ...
                            generateWindow(divObjCatalog, tovar, Number(urlObject['price']), Number(urlObject['oldprice']), urlObject['img'], urlObject['review'], urlObject['assessment'], pathbj, skidkaObj, [document.querySelector(".qwerty")], urlOOO)
                        })
                    }
